    ...
    <div class="container-wrapper">
        <div class="custom-card">
            <div class="form-section">
                <h3 class="text-center">Edit Obat</h3>

                <form action="{{ route('obatobatan.update', $obat->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="jumlah_stok" class="form-control" value="{{ $obat->jumlah_stok }}" required>
                        </div>
                        <div class="col-md-6 mb-3">
            ...
            <div class="image-section">
                @if ($obat->gambar)
                    <img src="{{ asset('images/icon.png') }}" alt="Gambar Obat">
                @else
