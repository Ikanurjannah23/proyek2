...
<head>
    ...
    <title>{{ $aksesoris->nama }} | Khakiel PetShop</title>
...
<div class="container py-5">
    <a href="{{ route('kebutuhanaksesoris') }}" class="back-link">&larr; Kembali ke Aksesoris</a>

    <div class="row product-container">
        <div class="col-md-5 mb-4 mb-md-0">
            <img src="{{ asset('storage/' . $aksesoris->gambar) }}" alt="{{ $aksesoris->nama }}" class="product-img">
        </div>
        <div class="col-md-7">
            <h1 class="product-title">{{ $aksesoris->nama }}</h1>
            <p class="badge-info">
                Jenis: <strong>{{ $aksesoris->jenis }}</strong> |
                Kategori: Aksesoris Hewan
            </p>
            <p class="product-price">Rp {{ number_format($aksesoris->harga, 0, ',', '.') }}</p>
            ...
            <div class="product-description">
                ...
                <p>{!! nl2br(e($aksesoris->deskripsi)) !!}</p>
            </div>

            {{-- Gambar tambahan --}}
            <div class="text-end">
                <img src="{{ asset('images/kucing.png') }}" alt="Aksesoris Terkait" class="related-img">
            </div>
        </div>
    </div>
</div>
