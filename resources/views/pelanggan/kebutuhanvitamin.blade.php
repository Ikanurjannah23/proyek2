...
<head>
    <meta charset="UTF-8">
    <title>Kebutuhan Vitamin | Khakiel PetShop</title>
...
<body>
    ...
    <div class="main-content">
        <h2 class="title">Kebutuhan Vitamin</h2>
                ...
                <div class="col-md-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route('kebutuhanvitamin.show', $item->id) }}" class="btn-detail mt-2">Lihat Selengkapnya</a>
                        </div>
                    </div>
                </div>
            @endforeach
