    ...
    <div class="container-wrapper">
        <div class="custom-card">
            <div class="form-section">
                <h3 class="text-center">Edit Produk Makanan</h3>
                ...
                <form action="{{ route('produkmakanan.update', $produk->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="jenis_produk" class="form-control" value="{{ old('jenis_produk', $produk->jenis_produk) }}">
                            @error('jenis_produk')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="jumlah_stok" class="form-control" value="{{ old('jumlah_stok', $produk->jumlah_stok) }}">
                            @error('jumlah_stok')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
